"""
Django settings for quote_calculator_38822 project.
...
ROOT_URLCONF = 'quote_calculator_38822.urls'
...
WSGI_APPLICATION = 'quote_calculator_38822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quote_calculator_38822 API",
    "DESCRIPTION": "API documentation for quote_calculator_38822 App",
    "VERSION": "v1",
}
